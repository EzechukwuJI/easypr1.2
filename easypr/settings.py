...
if 'DB_NAME' in os.environ:
    ...
    DEBUG_STATUS         =   False
    ALLOWED_HOSTS        =   ['easypr-test.us-west-2.elasticbeanstalk.com','www.easypr.ng','easypr.ng','127.0.0.1:8000']
else:
...
if 'RDS_DB_NAME' in os.environ:
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': 'P@$$W0rD13',                      # Not used with sqlite3.
