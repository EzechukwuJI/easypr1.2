...
from . models_field_choices import TITLE, COUNTRIES, FEEDBACK_STATUS, SERVICE_ITEM, SERVICE_TYPE, ACTION_TYPE, CTA, BLOG_CATEGORIES
# , ECONOMY_SECTOR
...
class UserAccount(models.Model):
    ...
    brand_logo                       =         models.ImageField(upload_to = "Client/logo/")
...
class ServiceCategory(models.Model):
  ...
  banner        =    models.FileField(upload_to ='banners/services_categories', null = True, blank = True)
...
class ServiceItem(models.Model):
  ...
  call_to_action     =    models.CharField(max_length = 75, null = True, blank = True, choices = CTA)
...
class BlogPost(models.Model):
    ...
    category                        =              models.CharField(max_length = 75, choices = BLOG_CATEGORIES)
    active                          =              models.BooleanField(default = True)
    tags                            =              models.CharField(max_length = 500)
    post_image                      =              models.ImageField(upload_to = "blogpost_images") 
